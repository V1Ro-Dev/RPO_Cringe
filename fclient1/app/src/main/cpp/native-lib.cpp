...
Java_ru_bmstu_Timex_fclient1_MainActivity_transaction(JNIEnv *xenv, jobject xthiz, jbyteArray xtrd) {
...
Java_ru_bmstu_Timex_fclient_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_ru_bmstu_Timex_fclient1_MainActivity_stringFromJNI(JNIEnv* env, jobject /* this */) {
    std::string hello = "Hello from C++";
    LOG_INFO("Hello from c++ %d", 2023);
    SLOG_INFO("Hello from spdlog {0}", 2023);
    return env->NewStringUTF(hello.c_str());
...
Java_ru_bmstu_Timex_fclient1_MainActivity_initRng(JNIEnv *env, jclass clazz) {
...
Java_ru_bmstu_Timex_fclient1_MainActivity_randomBytes(JNIEnv *env, jclass, jint no) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_ru_bmstu_Timex_fclient1_MainActivity_encrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data)
{
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_ru_bmstu_Timex_fclient1_MainActivity_decrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data)
{
    jsize ksz = env->GetArrayLength(key);
    jsize dsz = env->GetArrayLength(data);
